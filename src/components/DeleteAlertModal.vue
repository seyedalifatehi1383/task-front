<template>
    <div class="modal-bg" @click="closeDeleteModal"></div>
...
const emit = defineEmits(['close-delete-modal', 'delete-task']);

function closeDeleteModal() {
    emit('close-delete-modal'); // Emit the 'close-modal' event to the parent component
}
