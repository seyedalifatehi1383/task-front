...
<template>
    <Messagemodal @close-modal="checkClickEdit = false" v-if="checkClickEdit" :group="editDefualt.group"
        :title="editDefualt.title" :text="editDefualt.text" :id="editDefualt.id" />
        ...
        <div class="MessageAll" v-for="Message in Messages">
            ...
            <div v-else align="right">
                ...
                <div class="edit-Delete-Message">
                    ...
                    <svg @click="EditMessage(Message.title, Message.text, Message.group, Message.id)"
                        style="margin-left: 10px; cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <svg @click="DeleteMessage(Message.id)" style="cursor: pointer;" xmlns="http://www.w3.org/2000/svg"
